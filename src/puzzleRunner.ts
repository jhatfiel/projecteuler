...
import(jsfile).then(clazz => {
    ...
    console.log(`[${performance.measure('elapsed', 'start').duration.toFixed(2).toString().padStart(12, ' ')}ms]: [${puzzle.stepNumber.toString().padStart(5, ' ')}] Final result: ${puzzle.result}`);
